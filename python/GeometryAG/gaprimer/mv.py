...
class Mv(printer.GaPrintable):
    ...
    def reflect_in_blade(self, blade: 'Mv') -> 'Mv':  # Reflect mv in blade
        ...
        if blade.is_blade():
            ...
            blade_inv = blade.rev() / blade.qform()
    ...
    def qform(self) -> Expr:
        ...
        - Returned object is a real SymPy expression, NOT an Mv class
          ...
          number only when A's geometric algebra has a Euclidean metric.
        """
    ...
    def norm2(self, hint:str='0') -> Expr:
        ...
        - A.norm2() returns a real SymPy expression, NOT a 0-vector from 
          class Mv.  Whether numeric or symbolic, A.norm2() always 
    ...
    def mag2(self) -> Expr:
        ...
        - Returns the magnitude squared of multivector self, defined as
          ...
          grade parts.
        - Returned object is a real SymPy expression, NOT an Mv class
          0-vector.  Expression necesssarily represents a nonnegative 
          number.
...
def norm2(A:Mv, hint:str='0') -> Expr:
    ...
    - Returns the normsquared of multivector self, defined as the
      absolute value of the quadratic form at self.
    - norm2(A() returns a real SymPy expression, NOT a 0-vector from 
      class Mv.  Whether numeric or symbolic, norm2(A) always 
      represents a nonnegative number.
    - String values '+', '-', or '0' of hint respectively determine
      whether the quadratic form the absolute value of which is the 
      norm squared should be regarded as nonnegative, nonpositive, 
...
def mag2(A:Mv) -> Expr:
    ...
    - Returns the magnitude squared of multivector `self`, which is defined
      as the sum of the absolute values of the normsquareds of self's grade 
      parts.
    - Returned object is a real SymPym expression, NOT an Mv class 0-vector.
      Expression necesssarily represents a nonnegative number.
    - The magnitude squared differs from the normsquared of `self` when the
