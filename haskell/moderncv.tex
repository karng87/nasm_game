...
\cvlistitem{seperated by comma, like nested loops}
...
\cvitem{}{if it takes a function as an argument or return a function a fucntion as a result.}
\cvlistitem{${twice}\; :: (a \to a) \to a \to a$}
\cvlistitem{${twice}\; f\; x\; = f\; (\;f \; x\;)$}
