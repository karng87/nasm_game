...
\cvlistitem{반드시 정해진 규격으로 만들어서 분류 할 수 있게 하는 개념}
...
\subsection{<< Type Id parameters = TypeConstructor Id parameters $\mid$ ... >>}
...
\cvitem{IO ()}{Doesn't really have any kind of meaningfull return value}
