 ...
 */
typedef b8 (*PFN_on_event)(unsigned short code, void* sender, void* listener_inst, event_context data);
 ...
 */
API b8 event_register(unsigned short code, void* listener, PFN_on_event on_event);
 ...
 */
API b8 event_unregister(unsigned short code, void* listener, PFN_on_event on_event);
 ...
 */
API b8 event_fire(unsigned short code, void* sender, event_context context);
